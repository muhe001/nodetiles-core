  ...
  layers.forEach(function(layer, i) {
    ...
    attachments.forEach(function(attachment) {
      ...
      features.forEach(function(feature) {
        ...
        styles.forEach(function(style, s) {
...
var cartoGridRenderer = function (ctx, scale, layers, styles, zoom) {
  ...
  layers.forEach(function(layer, i) {
    var source = layer.source;
    var features = layer.features || layer;
    features.forEach(function(feature, f) {
      ...
      var renderAttachment = function(attachmentName) {
        ...
        if (shouldMark) {
          ...
          var diameter = attachmentStyle["marker-width"] || attachmentStyle["marker-height"];
          ...
          renderDot[shape.type].call(ctx, radius*0.8, coordinates);
        ...
        else if (shouldFill || shouldStroke) {
          ctx.beginPath();
          var shape = feature.geometry || feature;
          var coordinates = shape.coordinates;
          renderPath[shape.type].call(ctx, coordinates, scale);
